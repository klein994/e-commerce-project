...
const LogInWidget = () => {
    return (
        <>
            ...
            {/*     className="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 justify-center items-center h-modal md:h-full md:inset-0">*/}
            ...
            {/*                </button>*/}
            {/*            </div>*/}
            {/*            <form className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8 z-50" action="#">*/}
