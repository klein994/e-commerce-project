...
const CartWidget = () => {
    const {cartList, vaciarCarrito, deleteItem, cantidadProductos, precioTotal, formatNumber} = useCartContext()
    ...
    return (
        <>
            ...
            <button id="dropdownBottomButton" data-dropdown-toggle="dropdownBottom" data-dropdown-placement="bottom"
                    ...
                    type="button"><span
                className="absolute ml-1 -mt-3  bg-blue-100 text-blue-800 text-sm font-medium  px-2.5 py-0.5 rounded-full ">{cantidadProductos()}</span><IoBagHandleOutline/>
            </button>
            <div id="dropdownBottom"
                 className="hidden z-10 p-3 max-w-md bg-white rounded divide-y divide-gray-100 shadow-xl ">
